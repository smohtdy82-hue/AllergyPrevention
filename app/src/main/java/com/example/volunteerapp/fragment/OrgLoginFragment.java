...
/**
 * شاشة تسجيل دخول المؤسسة.
 * <p>
 * تتحقق من بيانات الاعتماد (البريد وكلمة السر) عبر {@link VolunteerAppHelper}
 * وتُبلّغ {@link OnLoginSuccess} عند نجاح العملية، أو تنقل المستخدم إلى التسجيل
 * عبر {@link OnGoRegister}.
 * </p>
 */
public class OrgLoginFragment extends Fragment {
    ...
    /** واجهة رد الاتصال عند نجاح تسجيل دخول المؤسسة. */
    public interface OnLoginSuccess {
        void onOrgLoggedIn(Organization org);
    }

    /** يُستدعى عند رغبة المستخدم بالانتقال إلى شاشة تسجيل مؤسسة جديدة. */
    ...
    /**
     * يبني واجهة تسجيل الدخول ويُعدّ مستمعات أزرار الدخول والانتقال للتسجيل.
     * يتم التحقق في خيط خلفي لتجنّب تجميد واجهة المستخدم.
     */
    @Nullable
    @Override
