...
import com.example.volunteerapp.adapter.OrganizationAdapter;
import com.example.volunteerapp.model.Organization;

import java.util.ArrayList;

/**
 * شاشة عرض قائمة المؤسسات التطوعية المتاحة مع إمكانية التقديم عليها مباشرة.
 * تجلب بيانات المؤسسات من الخادم وتعرضها في قائمة.
 */
public class OrganizationsListFragment extends Fragment {
    ...
    /**
     * إنشاء نسخة جديدة مع تمرير معرّف الطالب لاستخدامه عند التقديم.
     *
     * @param studentId معرّف الطالب الحالي
     * @return نسخة مُهيّأة من OrganizationsListFragment
     */
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnApplyClickListener(org -> {
            DALAppWriteConnection.OperationResult<VolunteerApplication> result = helper.applyToOpportunity(studentId, org.getId(), null);
            if (result.success) {
